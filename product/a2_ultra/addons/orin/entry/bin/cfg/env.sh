...
chown_to_user "/agibot/data/ota/firmware/v0" $USER_UID $USER_GID #TODO: 
...
# -------------------------------------------------------------
# 网络相关的环境变量 (orin, slave)
# -------------------------------------------------------------

export AGIBOT_LOCAL_HOST_IP="127.0.0.1"
export AGIBOT_LOCAL_HOST_NAME="agi"
export AGIBOT_NEIGHBOR_HOST_IP="192.168.100.100"
export AGIBOT_NEIGHBOR_HOST_NAME="agi"

export AGIBOT_MASTER_IP="${AGIBOT_NEIGHBOR_HOST_IP}"
export AGIBOT_GATEWAY_IP="${AGIBOT_LOCAL_HOST_IP}"

export MQTT_BROKER_IP="${AGIBOT_GATEWAY_IP}"

export MC_IP="${AGIBOT_NEIGHBOR_HOST_IP}"
export PNC_IP="${AGIBOT_LOCAL_HOST_IP}"
